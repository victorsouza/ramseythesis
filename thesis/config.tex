...
\newtheorem{_noprooftheorem}[theorem]{Teorema}
\newenvironment{noprooftheorem}
  {\pushQED{\qed}\begin{_noprooftheorem}}
  {\popQED\end{_noprooftheorem}}
\newtheorem{_noproofcorollary}[theorem]{Corolário}
\newenvironment{noproofcorollary}
  {\pushQED{\qed}\begin{_noproofcorollary}}
  {\popQED\end{_noproofcorollary}}
